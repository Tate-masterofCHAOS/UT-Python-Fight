...
def main():
    ...
    while running:
        ...
        max_hp_bar = pygame.Rect(50, 1010, player.max_health * 2, 40)
        current_hp_bar = pygame.Rect(50, 1010, player.health * 2, 40)
